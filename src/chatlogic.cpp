...
ChatLogic::~ChatLogic()
{
    // _nodes owns its GraphNodes via unique_ptr and cleans up automatically;
    // _chatBot is a non-owning back-pointer into the root GraphNode's ChatBot.
}
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            {
                                std::cout << "Error: EDGE references an unknown PARENT or CHILD node. Line is ignored!" << std::endl;
                            }
                            else
                            {
                                // create new edge
